...
Pix Watched, based on the Big Time watch by Pebble
 */
...
#define MY_UUID {0x99, 0x13, 0x8c, 0xa6, 0x2c, 0xc3, 0x4f, 0x87, 0x95, 0x2f, 0x87, 0x4d, 0x4d, 0xa4, 0x4a, 0x13}
PBL_APP_INFO(MY_UUID, "Pix", "Ice2097", 0x5, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
...
void load_digit_image_into_slot(int slot_number, int digit_value) {
  ...
  image_containers[slot_number].layer.layer.frame.origin.y = (slot_number / 2) * 76;
...
void handle_minute_tick(AppContextRef ctx, PebbleTickEvent *t) {
  ...
  string_format_time(date_text, sizeof(date_text), "%b. %e %a.", t->tick_time);
...
void handle_init(AppContextRef ctx) {
  ...
  text_layer_set_font(&text_date_layer, fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_PIX_15)));
